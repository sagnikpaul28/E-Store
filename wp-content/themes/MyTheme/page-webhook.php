...
<?php namespace Instamojo;
class Instamojo {
    const version = '1.1';
    protected $curl;
    protected $endpoint = 'https://www.instamojo.com/api/1.1/';
    protected $api_key = '3a91ca411f4ad6365d3977e5d534b28d';
    protected $auth_token = '367b2fb43864e630ff91f1b42273deab';
    /**
...
if($mac_provided == $mac_calculated){
    ...
    $wpdb->query("TRUNCATE TABLE 'username_".$_SESSION['username']".'");
}
else{
